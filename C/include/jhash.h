/*
 * This file is borrowed from linux kernel. It is quite useful to calculate
 * hash list position.
 *
 * jhash(key, length, initval)
 * jhash2(k, length, initval)
 * jhash_3words(a, b, c, initval)
 * jhash_2words(a, b, initval)
 * jhash_1word(a, initval)
 */
 ...
 */
static __inline u32 jhash2(const u32 *k, u32 length, u32 initval)
{
	u32 a, b, c, len;
